            ...
            <tr class="history-row${isCurrent ? ' is-current' : ''}" data-date="${commit.date}" data-message="${escapedMessage}" data-author="${escapeHtml(commit.author)}">
                ...
                <td class="history-cell-actions">
                    ${isCurrent
                        ...
                        : `<button class="nbe-btn nbe-btn--dark nbe-btn--tonal nbe-btn--sm" data-action="restore-commit" data-hash="${escapeHtml(commit.hash)}" data-message="${escapedMessage}">Restore</button>`
                    }
                </td>
            </tr>
        `;
